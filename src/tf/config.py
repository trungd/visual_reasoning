...
def parseArgs():
    ...
    parser.add_argument("--dataBasedir", default="/scratch/trungvd/dlex/datasets/CLEVR/raw", type=str,
...
def configCLEVR():
    config.dataPath = "{dataBasedir}/CLEVR_v1.0/questions".format(dataBasedir=config.dataBasedir)
